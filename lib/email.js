...
<body style="margin:0;padding:0;background:${C.cream2};">
...
<div style="display:none;font-size:1px;color:${C.cream2};line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">
  ${esc(preheader)}&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;
</div>

<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:${C.cream2};">
  <tr>
    <td align="center" style="padding:28px 12px;">

      <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0"
             style="width:600px;max-width:100%;background:${C.cream};border:1px solid ${C.rule};">

        <!-- Masthead -->
        <tr>
          <td align="center" style="padding:30px 28px 22px;background:${C.cream};">
...
function contactNotification(m) {
  const body = `
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="padding:18px 20px;background:${C.cream2};border-left:3px solid ${C.gold};font-family:${SERIF};font-size:16px;line-height:1.7;color:${C.ink};">
...
module.exports = { layout, contactNotification, esc, paragraphs, C, SERIF };
